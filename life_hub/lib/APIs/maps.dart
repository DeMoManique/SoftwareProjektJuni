...
Future<Route> fetchRoutes() async {
  ...
  final response = await http.get(Uri.parse('https://maps.googleapis.com/maps/api/directions/json?avoid=$avoid&destination=$des&mode=$mode&origin=$origin&key=$key'));
